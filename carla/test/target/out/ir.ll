...
.l0.carla.for_begin:
  ...
  br i1 %27, label %.l0.carla.for_check.grant, label %.l0.carla.for_check.less
.l0.carla.for_check.grant:
  %30 = icmp sgt i32 %29, %26
  br i1 %30, label %.l0.carla.for_body, label %.l0.carla.for_end
.l0.carla.for_check.less:
  %31 = icmp slt i32 %29, %26
  br i1 %31, label %.l0.carla.for_body, label %.l0.carla.for_end
.l0.carla.for_body:
...
; [CARLA DEBUG]: Function added to stack: print.
  ...
  %40 = call i8 @output.print(ptr %39)
; [CARLA DEBUG]: 0 items remaining in the stack.
; [CARLA DEBUG]: End of ID iteration 0
  ...
  br i1 %27, label %.l0.carla.for_decrement, label %.l0.carla.for_increment
