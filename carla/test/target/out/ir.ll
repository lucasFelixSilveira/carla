...
define ptr @test(ptr %0) {
  ...
  %9 = getelementptr inbounds [30 x i8], ptr @.carla.static.str.0, i32 0, i32 0
  store ptr %9, ptr %8, align 8
  %10 = load ptr, ptr %8, align 8
  %11 = alloca ptr, align 8
  %12 = getelementptr inbounds [13 x i8], ptr @.carla.static.str.1, i32 0, i32 0
  store ptr %12, ptr %11, align 8
  %13 = load ptr, ptr %11, align 8
  %14 = load ptr, ptr %2, align 8
  %15 = call i32 @string.format(ptr %7, ptr %10, ptr %13, ptr %14)
...
entry:
  ...
  %2 = alloca ptr, align 8
  %3 = getelementptr inbounds [3 x i8], ptr @.carla.static.str.2, i32 0, i32 0
  store ptr %3, ptr %2, align 8
  %4 = load ptr, ptr %2, align 8
  %5 = call ptr @test(ptr %4)
  store ptr %5, ptr %1, align 8
  %6 = load ptr, ptr %1, align 8
  %7 = call i32 @stdio.println(ptr %6)
  %8 = load ptr, ptr %1, align 8
  call void @heap.dump(ptr %8)
...
@.carla.static.str.0 = private constant [30 x i8] c"That is a '{s}' in Carla! {s}\00", align 1
@.carla.static.str.1 = private constant [13 x i8] c"Hello, World\00", align 1
@.carla.static.str.2 = private constant [3 x i8] c":3\00", align 1
