...
define ptr @test(ptr %0, i16 %1) {
  ...
  %11 = getelementptr inbounds [37 x i8], ptr @.carla.static.str.0, i32 0, i32 0
  store ptr %11, ptr %10, align 8
  %12 = load ptr, ptr %10, align 8
  %13 = alloca ptr, align 8
  %14 = getelementptr inbounds [13 x i8], ptr @.carla.static.str.1, i32 0, i32 0
  store ptr %14, ptr %13, align 8
  %15 = load ptr, ptr %13, align 8
  %16 = load ptr, ptr %3, align 8
  %17 = load i16, ptr %4, align 2
  %18 = call i32 @string.format(ptr %9, ptr %12, ptr %15, ptr %16, i16 %17)
...
entry:
  ...
  %3 = alloca ptr, align 8
  %4 = getelementptr inbounds [6 x i8], ptr @.carla.static.str.2, i32 0, i32 0
  store ptr %4, ptr %3, align 8
  %5 = load ptr, ptr %3, align 8
  %6 = load i32, ptr %1, align 4
  %7 = call ptr @test(ptr %5, i32 %6)
  store ptr %7, ptr %2, align 8
  %8 = load ptr, ptr %2, align 8
  %9 = call i32 @stdio.println(ptr %8)
  %10 = load ptr, ptr %2, align 8
  call void @heap.dump(ptr %10)
...
@.carla.static.str.0 = private constant [37 x i8] c"{s}! My name is {s} and I am {d} old\00", align 1
@.carla.static.str.1 = private constant [13 x i8] c"Hello, World\00", align 1
@.carla.static.str.2 = private constant [6 x i8] c"Lucas\00", align 1
