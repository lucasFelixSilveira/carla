...
; [CARLA DEBUG]: Struct output

define void @output.print(ptr %0) {
...
.l0.carla.for_begin:
  ...
  br i1 %25, label %.l0.carla.for_check.grant, label %.l0.carla.for_check.less
.l0.carla.for_check.grant:
  %28 = icmp sgt i32 %27, %24
  br i1 %28, label %.l0.carla.for_body, label %.l0.carla.for_end
.l0.carla.for_check.less:
  %29 = icmp slt i32 %27, %24
  br i1 %29, label %.l0.carla.for_body, label %.l0.carla.for_end
.l0.carla.for_body:
...
; [CARLA DEBUG]: Function added to stack: print.
  %37 = load ptr, ptr %31, align 8
  call void @output.print(ptr %37)
; [CARLA DEBUG]: 0 items remaining in the stack.
; [CARLA DEBUG]: End of ID iteration 0
  ...
  br i1 %25, label %.l0.carla.for_decrement, label %.l0.carla.for_increment
...
; [CARLA DEBUG]: Tab n: 1
@.carla.static.str.0 = private constant [21 x i8] c"The argument is: {s}\00", align 1
